---
title: "Employee — mai Filament\*, sempre XotBase*"
type: concept
module: Employee
tags: [employee, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Employee filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Employee` estende una classe `Filament\...` direttamente.
